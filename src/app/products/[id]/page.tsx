  ...
  return (
    <div className="min-h-screen">
      ...
      <main className="container mx-auto px-4 py-8 max-w-4xl">
        <Link href={backHref} className="text-emerald-600 hover:underline mb-4 inline-block min-h-[44px] flex items-center touch-manipulation">
          ← 戻る
        </Link>
                  ...
                  <tr key={s.id} className="border-b border-slate-100">
                    ...
                    <td className="py-2">
                      <SaleRowActions
                        sale={s}
                        productId={product.id}
                        productCostYen={product.cost_yen}
                        currentStock={product.stock}
                        stockAtHome={stockAtHome}
                        stockAtWarehouse={stockAtWarehouse}
                        feeRates={feeRates ?? []}
